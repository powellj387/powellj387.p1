...
public class HeartsComparator implements Comparator<Card>{
    public HeartsComparator(){}
    ...
    public int compare(Card card1, Card card2){
       ...
       //the first two if-statements ensure that the queen of spades always ends up at the end of the list
        if((suitValues[0] == 3) && (rankValues[0] == 11)){
            returnVal = 1;
        }else if((suitValues[1]==3) && (rankValues[1]==11)){
            returnVal = -1;
